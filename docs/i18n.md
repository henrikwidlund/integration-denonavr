...
- SimpleLocalize is used to translate texts: https://simplelocalize.io/suggestions/?id=07b8bc4d63144e75a5bb1100a0f2c971
...
‼️ Only the English reference language `en_US` should be updated. All other language files are handled by SimpleLocalize!
...
‼️ This is for reference and local use only. New project translation languages must be requested and created in SimpleLocalize.
